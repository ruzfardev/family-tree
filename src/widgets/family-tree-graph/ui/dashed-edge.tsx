...
function DashedEdge(props: EdgeProps) {
    ...
    const edgeStyle: CSSProperties = {
        ...style,
        stroke: isHighlighted ? 'var(--color-fg-brand-primary)' : 'var(--color-fg-quaternary)',
    ...
    const markerColor = isHighlighted ? 'var(--color-fg-brand-primary)' : 'var(--color-fg-quaternary)';
